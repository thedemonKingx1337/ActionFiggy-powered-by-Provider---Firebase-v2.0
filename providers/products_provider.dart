...
import '../../passing%20data%20between%20screens/dummydata.dart';
...
class Products_Provider with ChangeNotifier {
  ...
  Future<void> fetchProducts() async {
    const String firebaseUrl =
        "https://actionfigshoppyv1-default-rtdb.firebaseio.com/products.json";
      ...
      extractedData.forEach((IDkey, productData_value) {
        Loaded_products.add(
          Product(
              ...
              isFavorite: productData_value["isFavorited"]),
        );
      });
